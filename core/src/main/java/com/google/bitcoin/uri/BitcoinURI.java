...
public class BitcoinURI {
    ...
    public static final String BITCOIN_SCHEME = "paybullion";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        if (input.startsWith("paybullion://")) {
            schemeSpecificPart = input.substring("paybullion://".length());
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the premine: prefix");
